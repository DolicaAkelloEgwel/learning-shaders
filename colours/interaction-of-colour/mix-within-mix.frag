...
void main() {
    ...
    vec3 influencing_color_A = vec3(0.418,0.735,0.780); // top background
    vec3 influencing_color_a = vec3(0.065,0.066,0.290); // top horizontal bar
    vec3 influencing_color_b = vec3(0.865,0.842,0.162); // bottom horizontal bar
    vec3 influencing_color_B = vec3(0.980,0.603,0.086); // bottom background
